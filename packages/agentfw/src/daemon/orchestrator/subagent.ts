// The subagent cost-saver — agentfw's headline feature.
//
...
// and offers no knob to make the swarm cheaper. agentfw does: it reroutes
...
import { decoderToApi, type ModelRef, type ResolvedRoute, resolveModelRef } from './resolve.ts'
