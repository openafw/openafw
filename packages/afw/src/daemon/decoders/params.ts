...
const OMIT = new Set(['messages', 'input', 'system', 'instructions', 'tools', 'model', 'stream'])

export function extractRequestParams(req: unknown): Record<string, unknown> | undefined {
