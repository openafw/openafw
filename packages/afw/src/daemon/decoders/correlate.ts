 ...
 *  rewrites a wrapped agent's model to `afw-<agent>-<instance>` (e.g.
 *  `afw-openclaw-main`); the suffix is the instance. Returns undefined for
 ...
 *  `@<instance>` path segment minted by `afw run`) is authoritative
