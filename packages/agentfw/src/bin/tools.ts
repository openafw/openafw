#!/usr/bin/env node
// agentfw-tools — stdio MCP server exposing harness-provided tools to
...
// mcpServers entry in the agent's config covers the whole agentfw tool
// surface.
//
...
const SERVER_NAME = 'agentfw-tools'
