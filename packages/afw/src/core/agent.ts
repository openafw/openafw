/** A source-agent identifier. Built-in agents afw ships detectors for
 ...
 *  no afw code change needed for a new agent type. The detector
...
export type RuntimeMode = 'launch-per-task' | 'daemon-restartable' | 'repl-hotswappable' | 'manual'
