...
// Manifest files written by older agentfw versions. v1 entries lack the
...
export type BackupEntry = {
  ...
  /**
   * Schema version of this entry's `changes`. Entries written by agentfw
...
export type ChangeRecord =
   ...
   * again — the whole section for TOML (agentfw owns its provider id), or
