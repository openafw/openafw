...
export function getTomlString(text: string, section: string, key: string): string | undefined {
 ...
 */
export function setTomlTopLevelString(text: string, key: string, value: string): SetTomlResult {
  const lines = text.split('\n')
