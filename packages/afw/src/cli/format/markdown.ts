...
export function formatMarkdown(detail: RunDetail, opts: { redact: boolean }): string {
  ...
  out.push('---')
  out.push('')
  out.push(`_Captured by [afw](https://github.com/openafw/openafw) — \`afw report ${r.id}\`._`)
...
/** Same three-bucket convention as the rest of afw — see cli/tui/table.ts. */
