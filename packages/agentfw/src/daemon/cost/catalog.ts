...
// the agentfw package (run by maintainer at release time). Trimmed to
// providers agentfw users actually hit; full catalog is ~2 MB.
//
...
// to ~/.agentfw/pricing-catalog.json, it takes precedence over the bundled
