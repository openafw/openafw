...
function ep(partial: Pick<PlannedEndpoint, 'modelId' | 'configLocation'>): PlannedEndpoint {
  return {
    originalBaseUrl: 'https://up.example/v1',
    afwBaseUrl: 'http://localhost:9877/wire/hermes/x',
...
const base = ep({ modelId: 'afw-hermes-default', configLocation: '/model/base_url' })
const groq = ep({ modelId: 'afw-hermes-groq', configLocation: '/custom_providers/groq/base_url' })
const oai = ep({
  modelId: 'afw-hermes-openai',
  configLocation: '/custom_providers/openai/base_url',
})
