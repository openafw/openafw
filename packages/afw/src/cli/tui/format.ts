...
const SLOGAN = 'Putting afw on the wire…'

export function formatDetectionSummary(detections: Detection[], opts: { dryRun: boolean }): string {
  const lines: string[] = []
  lines.push(SLOGAN)
  lines.push('')
