...
/** A tool afw executed locally as part of an emulation loop —
 ...
 *  (afw ran the tool locally — any spend is the backend's
...
export async function captureChain(
  ...
  risk: RiskTag[],
  /** Tool executions afw ran during this fan-out (web_search via
